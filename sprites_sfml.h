...
public:
  ...
  sf::Sprite& get_RRH_sprite() noexcept { return m_RRH_sprite; }
  sf::Sprite& get_RRH_sprite2() noexcept { return m_RRH_sprite2; }
  sf::Sprite& get_wolf_sprite() noexcept { return m_wolf_sprite; }
  sf::Sprite& get_wolf_sprite2() noexcept { return m_wolf_sprite2; }
  ...
  sf::Sprite& get_RRH_wins() noexcept { return m_RRH_wins_sprite; }
